        ...
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="max-w-xl z-10">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed max-w-md">
              Find the right lawyer for your needs. Filter by specialization,
              experience, and book your consultation instantly.
            </p>
          </div>
            ...
            {initialLawyers.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm text-center">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-2 max-w-sm">
                  We couldn't find any lawyers matching your exact filters. Try
                  adjusting them to see more results.
                </p>
                <button
                  onClick={resetFilters}
                  className="mt-6 px-6 py-2 bg-teal-600 text-white text-sm font-semibold rounded-lg hover:bg-teal-700 transition-colors"
                >
                  Clear Filters
                </button>
              </div>
            ...
            {initialLawyers.length > 0 && (
              <div className="flex justify-center items-center gap-2 mt-12 mb-5">
                ...
                <div className="flex gap-1.5">
                  <button className="w-8 h-8 rounded-full bg-teal-600 text-white text-sm font-bold shadow-md shadow-teal-600/20">
                    1
                  </button>
                  <button className="w-8 h-8 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                    2
                  </button>
                  <button className="w-8 h-8 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 text-sm hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                    3
